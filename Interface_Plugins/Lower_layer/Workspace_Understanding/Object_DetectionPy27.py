...
class Object_Detection:
    def __init__(self, path='None'):
        ...
        self.graph = os.path.join(self.path_other,
                                  'Workspace_Understanding/models', 'frozen_inference_graph.pb')
        self.config = os.path.join(self.path_other,
                                   'Workspace_Understanding/models', 'ssd_mobilenet_v2_coco_2018_03_29.pbtxt.txt')
        ...
        # 拼接完整的文件路径
        class_names_path = os.path.join(self.path_other,
                                        'Workspace_Understanding/models', 'object_detection_classes_coco.txt')
    ...
    def getData(self):
        return self.detected_class, self.properties


# 测试代码
if __name__ == "__main__":
    obj_det = Object_Detection('Images/Photo.jpeg')
    obj_det.loading_model()
