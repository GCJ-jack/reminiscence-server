...
class ReminiscenceWindow(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.gxlabels["date"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.03), int(self.winsize_v * 0.08), int(self.winsize_h * 0.5), int(self.winsize_v * 0.08)))
        ...
        self.currdate.setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.05), int(self.winsize_v * 0.07), int(self.winsize_h * 0.15), int(self.winsize_v * 0.1)))
        ...
        self.gxlabels["WinName"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.4), int(self.winsize_v * 0.04), int(self.winsize_h * 0.3), int(self.winsize_h * 0.05)))

        # Hide

        self.gxlabels["hide"] = QtWidgets.QLabel(self)
        self.gxlabels["hide"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.9), int(self.winsize_v * 0.04), int(self.winsize_h * 0.04), int(self.winsize_v * 0.04)))
        ...
        self.gxlabels["close"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.95), int(self.winsize_v * 0.04), int(self.winsize_h * 0.04), int(self.winsize_v * 0.04)))
        icon_close = QtGui.QPixmap("Interface_Plugins/Upper_layer/ImgGui/close_main.png")
        icon_close = icon_close.scaled(int(self.winsize_h * 0.04), int(self.winsize_v * 0.04), QtCore.Qt.KeepAspectRatio,
                                       transformMode=QtCore.Qt.SmoothTransformation)
        ...
        self.gxlabels["upload"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.07), int(self.winsize_v * 0.89), int(self.winsize_h * 0.15), int(self.winsize_v * 0.06)))
        icon_upload = QtGui.QPixmap("Interface_Plugins/Upper_layer/ImgGui/Upload_rem.png")
        icon_upload = icon_upload.scaled(int(self.winsize_h * 0.15), int(self.winsize_v * 0.06), QtCore.Qt.KeepAspectRatio,
                                         transformMode=QtCore.Qt.SmoothTransformation)
        ...
        self.gxlabels["play"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.5), int(self.winsize_v * 0.88), int(self.winsize_h * 0.08), int(self.winsize_v * 0.08)))
        ...
        self.gxlabels["photo1_b"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.205), int(self.winsize_v * 0.28), int(self.winsize_h * 0.3), int(self.winsize_v * 0.45)))
        ...
        self.gxlabels["photo2_b"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.583), int(self.winsize_v * 0.28), int(self.winsize_h * 0.3), int(self.winsize_v * 0.45)))
        icon = QtGui.QPixmap("Interface_Plugins/Upper_layer/ImgGui/photo_rem.png")
        icon = icon.scaled(int(self.winsize_h * 0.3), int(self.winsize_v * 0.45), QtCore.Qt.KeepAspectRatio,
                           transformMode=QtCore.Qt.SmoothTransformation)
        ...
        self.gxlabels["photo1"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.215), int(self.winsize_v * 0.11), int(self.winsize_h * 0.8), int(self.winsize_v * 0.8)))

        self.gxlabels["photo2"] = QtWidgets.QLabel(self)
        self.gxlabels["photo2"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.5895), int(self.winsize_v * 0.11), int(self.winsize_h * 0.8), int(self.winsize_v * 0.8)))
        ...
        self.lcd.setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.9), int(self.winsize_v * 0.9), int(self.winsize_h * 0.055), int(self.winsize_v * 0.055)))
        self.lcd.display(strftime("%H" + ":" + "%M" + ":" + "%S"))
        self.lcd.setDigitCount(8)

        self.gxlabels["mini_sun"] = QtWidgets.QLabel(self)
        self.gxlabels["mini_sun"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.875), int(self.winsize_v * 0.905), int(self.winsize_h * 0.04), int(self.winsize_v * 0.04)))
        ...
        self.controlButtons['close'].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.945), int(self.winsize_v * 0.04), int(self.winsize_h * 0.035), int(self.winsize_v * 0.045)))
        ...
        self.controlButtons['hide'].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.895), int(self.winsize_v * 0.04), int(self.winsize_h * 0.035), int(self.winsize_v * 0.045)))
        ...
        self.controlButtons['play'].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.49), int(self.winsize_v * 0.88), int(self.winsize_h * 0.07), int(self.winsize_v * 0.08)))
        ...
        self.controlButtons['upload'].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.065), int(self.winsize_v * 0.88), int(self.winsize_h * 0.12), int(self.winsize_v * 0.08)))
        ...
        self.controlButtons['photo1'].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.203), int(self.winsize_v * 0.26), int(self.winsize_h * 0.255), int(self.winsize_v * 0.48)))
        ...
        self.controlButtons['photo2'].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.580), int(self.winsize_v * 0.26), int(self.winsize_h * 0.255), int(self.winsize_v * 0.48)))
    ...
    def set_recognImage(self, n):
        ...
        self.gxlabels["photomain"].setGeometry(
            QtCore.QRect(int(self.winsize_h * 0.32), int(self.winsize_v * 0.17), int(self.winsize_h * 0.6), int(self.winsize_v * 0.6)))
        # print('aqui', self.reminiscenceImage)
        # icon = "None"
